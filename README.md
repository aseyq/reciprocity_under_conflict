...
**3. Just demo the analysis/plots**
We already have a small simulation data in the repository for demonstration. You can test the analysis code by producing the plots using this small data. 
...
We tested this repository with the following machine:
