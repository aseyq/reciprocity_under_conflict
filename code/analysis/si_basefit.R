...
#ggsave(filename="plots/si_figure3_rep1.png", plot=figure3, width = 8, height = 5, units = "in", dpi = 300)

## Figure 4 - The relative success of strategies in a mixed populations =============================
figure4 <- df_default  %>%
    filter(popstr %in% c("onlyattacker", "attackermaj", "equal", "attackermin", "onlydefender")) %>% 
mutate(rel_mean = mean / size)  %>%
    group_by(
        popstr,
        prob_rep,
...
ggsave(filename="plots/SI_success_basefit0.1.png", plot=figure4, width = 9, height = 4, units = "in", dpi = 300)
...
ggsave(filename="plots/figure5_rep1.png", plot=figure5, width = 9, height = 4.5, units = "in", dpi = 300)
...
ggsave(filename="plots/si_figure6a_rep1.png", plot=figure6a, width = 5, height = 6, units = "in", dpi = 300)
...
ggsave(filename="plots/si_figure6b_rep1.png", plot=figure6b, width = 6, height = 5, units = "in", dpi = 300)


figure6 <- figure6a + figure6b
ggsave("plots/si_figure6_rep1.png", plot=figure6, width = 11, height = 6, units = "in", dpi = 300)
